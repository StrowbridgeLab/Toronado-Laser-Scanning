...
"""
    dict with case insensitive keys from tivvit downloaded from GitHub on 20 Mar 2016 (renamed EasyDict)
    link: https://github.com/tivvit/python-case-insensitive-dict
    License: CaseInsensitiveDict has a MIT license
"""
